 ...
 */            (function(window, factory) {
    ...
    (() => {
        ...
        da.init();
        const imageBlocks = document.querySelectorAll(".cc");
        const script_customCursor = document.querySelector(".custom-cursor");
        let cursorX = 0;
        let cursorY = 0;
        imageBlocks.forEach((block => {
            block.addEventListener("mouseenter", (() => {
                script_customCursor.style.display = "flex";
            }));
            block.addEventListener("mouseleave", (() => {
                script_customCursor.style.display = "none";
            }));
        ...
        function updateCursorPosition() {
            script_customCursor.style.left = `${cursorX}px`;
            script_customCursor.style.top = `${cursorY}px`;
            requestAnimationFrame(updateCursorPosition);
        }
        window["FLS"] = true;
        isWebp();
